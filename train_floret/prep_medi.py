...
def prep_dump(loader):
  ...
  ofile_name128 = "medical_sentences.txt"
...
acrawl2 = load_dataset("turkish-nlp-suite/Medikal-Ozetler", split="train")
aload2 = DataLoader(acrawl2, batch_size=1000)

acrawl3 = load_dataset("turkish-nlp-suite/Medikal-Makaleler", split="train")
aload3 = DataLoader(acrawl3, batch_size=1000)

academic_crawls = [aload3, aload2]
